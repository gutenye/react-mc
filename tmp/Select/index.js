...
class Select extends React.Component {
  ...
  // prettier-ignore
  foundation_ = new MDCSelectFoundation({
    ...
    deregisterInteractionHandler: helper.deregisterInteractionHandler(
      'root',
      this
    ),
    ...
    getComputedStyleValue: propertyName =>
      window.getComputedStyle(this.refs.root).getPropertyValue(propertyName),
    ...
    setMenuElAttr: (attr, value) =>
      this.setState({ menuAttr: { ...this.state.menuAttrs, [attr]: value } }),
    rmMenuElAttr: attr =>
      this.setState({ menuAttr: { ...this.state.menuAttr, [attr]: null } }),
