...
class Snackbar extends React.Component {
  ...
  // prettier-ignore
  foundation_ = new MDCSnackbarFoundation({
    ...
    registerTransitionEndHandler: helper.registerHandler(
      'root',
      TRANS_END_EVENT_NAME,
      this
    ),
    deregisterTransitionEndHandler: helper.deregisterHandler(
      'root',
      TRANS_END_EVENT_NAME,
      this
    ),
